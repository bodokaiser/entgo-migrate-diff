...
import (
	...
	"github.com/bodokaiser/entgo-migrate-diff/ent/predicate"
...
func (m *UserMutation) SetAttr(value map[string]string) {
	m.attr = &value
}

// Attr returns the value of the "attr" field in the mutation.
func (m *UserMutation) Attr() (r map[string]string, exists bool) {
	v := m.attr
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldAttr(ctx context.Context) (v map[string]string, err error) {
	if !m.op.Is(OpUpdateOne) {
